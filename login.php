...
<body>
    ...
    <div class="container">
        <form class="text-center" action="valid_login.php" method="POST">
            <div class="form-floating mb-3">
                ...
                <div id="emailHelp" class="form-text text-start">Ne partagez jamais vos identifiants avec quelqu'un d'autre.</div>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="floatingPassword" placeholder="Entrez votre mot de passe..." aria-describedby="passHelp" required>
